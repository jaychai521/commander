...
cc.Class({
    ...
    start () {
        ...
        this.receivedNode.getComponent(cc.Button).node.on('click',function () {
            //对玩家进行奖励
            GoldSystem._instance.YBOperate(this.yb);
            GoldSystem._instance.LeavesOperate(this.leaves);
            // ComdUIManager._instance.showTip('获得爱心x' + this.yb + ',树叶x' + this.leaves);
            ComdUIManager._instance.showAssetTip_Comd('章+' + this.yb + '\n票+' + this.leaves);
            //服务器发送奖励消息
